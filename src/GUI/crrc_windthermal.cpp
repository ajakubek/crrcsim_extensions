  ...
  : CRRCDialog()
{
  ...
  comboPresetsWind->setLabel("Load Preset");
  ...
  slider_windVelocity->setLabel("velocity [ft/s]");
  ...
  slider_windDir->setLabel("direction");
  ...
  inputNewWind->setValue("name of new preset");
  ...
  comboPresetsThermal = new puaComboBox(LABEL_W + DLG_DEF_SPACE, BUTTON_BOX_HEIGHT + 8* DLG_DEF_SPACE + 8* SLIDER_H + 0*COMBO_H,
                                       ...
                                       presetsThermal, false);
  comboPresetsThermal->setLabelPlace(PUPLACE_CENTERED_LEFT);
  comboPresetsThermal->setLabel("Load Preset");
  ...
  slider_thermalStrengthMean->setLabel("strength mean [ft/s]");
  ...
  slider_thermalStrengthSigma->setLabel("strength sigma");
  ...
  slider_thermalRadiusMean->setLabel("radius mean [ft]");
  ...
  slider_thermalRadiusSigma->setLabel("radius sigma");
  ...
  slider_thermalLifetimeMean->setLabel("lifetime mean [seconds]");
  ...
  slider_thermalLifetimeSigma->setLabel("lifetime sigma");
  ...
  slider_thermalDensity->setLabel("density [1/sq foot]");
  ...
  inputNewThermal->setValue("name of new preset");
