...
namespace Power
{
  ...
  class Battery
  {
    public:
     ...
     /**
      * Read parameters for automagic construction from xml and create
      * elements below.
      */
     void automagic(SimpleXMLTransfer* xml);
      ...
      */
     void reset(CRRCMath::Vector3 vInitialVelocity);
    ...
    private:
     ...
     /**
      * Status für Unterspannungsabschaltung
      */
     int nUOffStatus;
