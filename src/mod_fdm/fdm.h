 ...
 *   Copyright (C) 2005, 2006, 2007, 2008 - Jens Wilhelm Wulf (original author)
...
class FDMBase
{
  ...
  public:
    ...
    */
   virtual CRRCMath::Vector3 getVel() { CRRCMath::Vector3 r; r = CRRCMath::Vector3(); return(r); };
   virtual CRRCMath::Vector3 getAccel() { CRRCMath::Vector3 r; r = CRRCMath::Vector3(); return(r); };
   
   virtual CRRCMath::Vector3 getPQR() { CRRCMath::Vector3 r; r = CRRCMath::Vector3(); return(r); };
   ...
   /**
    * connect fdm with animations to be able to calculate stuff
    * for moving parts
    */
   virtual void registerAnimations(std::vector<CRRCAnimation*> const& anims) {}
 ...
 * the application and to provide a lean interface. The long term goal is to be
 * able to use different models (beside larcsim).
 *
 * @author Jens Wilhelm Wulf
 */
class ModFDMInterface
{
  public:
    ...
    */
   void loadAirplane(const char* filename, 
                     FDMEnviroment* myEnv,
