...
inline uint16_t InterfaceSocket::littleendians(uint16_t a)
{
...
inline uint16_t InterfaceSocket::bigendians(uint16_t a)
{
  #if __BYTE_ORDER == __LITTLE_ENDIAN
  uint8_t* b = (uint8_t*)&a;
  uint8_t tmp;
...
inline uint32_t InterfaceSocket::littleendianl(uint32_t a)
{
  #if __BYTE_ORDER == __LITTLE_ENDIAN
  return a;
  #else
...
inline uint32_t InterfaceSocket::bigendianl(uint32_t a)
{
  #if __BYTE_ORDER == __LITTLE_ENDIAN
  uint8_t* b = (uint8_t*)&a;
  uint8_t tmp;
...
void InterfaceSocket::put_state_data(struct imu *imudata, struct gps *gpsdata, struct servo *servopacket)
{
 ...
 ***************************************************************************************/
bool InterfaceSocket::checksum(uint8_t* buffer, int packet_len)
{
 ...
 ***************************************************************************************/
void InterfaceSocket::encode_gpspacket(struct gps *data, uint8_t* buffer)
{
   //signed long tmp=0;
   int tmp32;
   short i;
...
void InterfaceSocket::encode_ahrspacket(struct imu *data, uint8_t* buffer)
{
   signed short tmp16;
...
void InterfaceSocket::encode_servopacket(struct servo *servopacket, uint8_t* buffer)
{
   buffer[ 0] = 'F';
 ...
 ***************************************************************************************/
void InterfaceSocket::encode_packet(struct imu *data, struct gps *gpsdata, struct servo *servopacket, uint8_t* buffer)
{
...
// display message
//+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
void InterfaceSocket::display_message(struct imu *data, struct gps *gdata)
{
   //static int count=0;
